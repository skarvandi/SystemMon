...
const wchar_t
kstring::GetAt(size_t index) const
{
...
UNICODE_STRING *
kstring::GetUnicodeString(PUNICODE_STRING pUnicodeString)
{
...
wchar_t *
kstring::Allocate(size_t chars, const wchar_t * src)
{
...
kstring &
kstring::Append(PCWSTR str, ULONG len)
{
    if (len == 0)
